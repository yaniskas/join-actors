package join_patterns.matching.multiple_filtering
...
class MultipleFilteringMatchingTree[M, T](private val pattern: JoinPattern[M, T], private val patternIdx: Int):
